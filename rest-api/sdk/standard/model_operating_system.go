...
type OperatingSystem struct {
	...
	// Synchronization scope for iPXE Operating Systems; nil for Image OS. Local: single site, bidirectional sync (provider-owned, originating from nico-core). Global: rest-to-core for all owner sites. Limited: rest-to-core for specific sites
